  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += JobeetJobPeer::doOnDeleteCascade(new Criteria(JobeetJobPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += JobeetJobPeer::doOnDeleteCascade($criteria, $con);
			...
			// invalidate objects in JobeetJobAffiliatePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = JobeetJobPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {


			// delete related JobeetJobAffiliate objects
			$c = new Criteria(JobeetJobAffiliatePeer::DATABASE_NAME);
			
			$c->add(JobeetJobAffiliatePeer::JOB_ID, $obj->getId());
			$affectedRows += JobeetJobAffiliatePeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
